                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          },icon: Icon(Icons.navigate_before,size: 50,color: Colors.blue,),)
                          ,),
                        Container(
                          child: Column(
                            children: <Widget>[
                              Text("Ürün Detayı", style: TextStyle(
                                  fontSize: 24,
                        ...
                        Container(
                          padding: EdgeInsets.only(right: 15,top:0,bottom: 10),
                          //margin: EdgeInsets.only(bottom: 10),
                          child: IconButton(onPressed: (){},icon: Icon(Icons.shopping_basket,size: 40,color: Colors.blue,),)
                          ,),
                      ],
                    ),
                  ),
